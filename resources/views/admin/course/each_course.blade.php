                            ...
                            <div class="row justify-content-center">
                                <div class="col-xl-4 col-lg-5 col-md-6">
                                    <div class="preview_video">
                                        <a href="#" class="fcrse_img" data-bs-toggle="modal"
                                            ...
                                            <img src="{{ asset('courseThumbnail/' . $courseAttachment->thumbnail_url) }}"
                                ...
                                <script>
                                    ...
                                    videoModal.addEventListener('show.bs.modal', function(event) {
                                        ...
                                        var videoUrl = "{{ asset('courseVideo/' . $courseAttachment->url) }}"; // Video URL
                                ...
                                <div class="tab-pane fade show active" id="nav-about" role="tabpanel">
                                    <div class="_htg451">
                                        ...
                                        <div class="_htg452 mt-35">
                                            ...
                                            <p>Hi! Welcome to the {{ $courseDetail->title }}, the <strong>only course you need
                                                    to learn {{ $courseDetail->learn_in_course }}</strong>. There are a lot of options for online
                                        ...
                                        <div id="accordion" class="ui-accordion ui-widget ui-helper-reset">
                                            ...
                                            <div
                                                ...
                                                <div class="lecture-container">
                                                    ...
                                                    <div class="details">
                                                        <span class="content-summary">01:18</
                                                        </div>
                                                    </div>
                                                    <div class="lecture-container">
                                                        <div class="left-content">
