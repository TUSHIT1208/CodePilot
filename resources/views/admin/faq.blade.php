                ...
                <div class="col-lg-12">
                    <div class="accordion" id="faqAccordion">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="faqCollapse1" class="accordion-collapse collapse show footer"
                                aria-labelledby="faqHeading1" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    <p>To create a new course, click on the "Create Your Course" button on the
                                        dashboard, fill in the required details, and submit your course for review.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                <form action="" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="addFaqModalLabel"><i class="uil uil-plus-circle"></i> Add a New FAQ
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="answer" name="answer" rows="4"
                                placeholder="Enter the FAQ answer" required></textarea>
                            @error('answer')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
