...
<div class="wrapper">
    <div class="sa4d25">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="st_title"><i class="uil uil-folder-plus"></i>  </h2>
                </div>
            </div>
    ...
    $(document).ready(function () {
                            ...
                            success: function (response) {
                                if (response.success) {
                                    ...
                                    selectedIds.forEach(id => {
                                        $('#ucp-table tbody input.faq-checkbox[value="' + id + '"]').closest('tr').remove();
                                    });
        ...
        $(document).on('click', '.delete-btn', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/faq/' + id, // Ensure correct delete route
                        type: 'DELETE',
                        ...
                        success: function (response) {
                            if (response.success) {
                                ...
                                // Remove the deleted row dynamically
                                $('#ucp-table tbody input.faq-checkbox[value="' + id + '"]').closest('tr').remove();
                            } else {
                                toastr.error(response.error || 'Failed to delete.', 'Error');
                            }
