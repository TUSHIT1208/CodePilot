                        ...
                        <div class="table-responsive mt-30">
                            ...
                            @else
                                <table id="learningPathTable" class="ucp-table">
                                    <thead>
                                        <tr>
                                            <th class="text-center ucp-table"><input type="checkbox" id="select-all"></th>
                                            <th class="text-center ucp-table">No.</th>
                                            <th class="text-center ucp-table">Learning Path Name</th>
                                            <th class="text-center ucp-table">Description</th>
                                            <th class="text-center ucp-table">Actions</th>
                                        </tr>
                                    </thead>
                                    <tbody class="text-center ucp-table"></tbody>
                                </table>
                            @endif
                        </div>
                    </div>
