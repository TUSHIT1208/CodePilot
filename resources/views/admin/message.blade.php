                                    ...
                                    <div class="group_messages">
                                        <div class="chat__message__dt active">
                                            <div class="user-status">
                                                ...
                                                <p class="user-status-text">Hi! Sir, How are you. I ask you one thing
                                                    please explain it this video price.</p>
                                        ...
                                        <div class="chat__message__dt">
                                            <div class="user-status">
                                                ...
                                                <p class="user-status-text">Hello, I paid you video tutorial but did not
                                                    play error 404.</p>
                                        ...
                                        <div class="chat__message__dt">
                                            <div class="user-status">
                                                ...
                                                <p class="user-status-text">Hi! Sir, this is a purchase key
                                                    CFKX12536ERUJSKLL</p>
                                        ...
                                        <div class="chat__message__dt">
                                            <div class="user-status">
                                                ...
                                                <p class="user-status-text">Hi Sir thank you very very much for
                                                    bootstrap full course.</p>
                                        ...
                                        <div class="chat__message__dt">
                                            <div class="user-status">
                                                ...
                                                <p class="user-status-title"><span class="bold">Jaysen Batchelor</span>
                                                </p>
                                        ...
                                        <div class="chat__message__dt">
                                            <div class="user-status">
                                                ...
                                                <p class="user-status-title"><span class="bold">Quinton Batchelor</span>
                                                </p>
                                    ...
                                    <div class="message-send-area">
                                        <form>
                                            <div class="mf-field">
                                                ...
                                                <button class="add_msg" type="submit"><i
