                                ...
                                <div class="table-responsive mt-30">
                                    @if($subcategories->isEmpty())
                                        ...
                                        <div class="no-categories-container text-center fade-in-animation footer">
                                            ...
                                            <p class="mb-4 fade-in-text" style="color: #aaa;">It looks like you don't have any Sub-categories yet. Add one now to get started!</p>
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control _dlor1" id="subcategory_name_{{ $subcategory->id }}"
                                   name="subcategory_name_edit" value="{{ $subcategory->name }}" placeholder="Enter the subcategory name">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control _dlor1" id="subcategory_description_{{ $subcategory->id }}"
                                      name="subcategory_description_edit" rows="4" placeholder="Enter the subcategory description ( OPTIONAL )">{{ $subcategory->description }}</textarea>
                            <div class="invalid-feedback"></div>
                        </div>
                    </div>
