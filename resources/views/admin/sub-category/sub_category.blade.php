                ...
                <div class="modal-content">
                    <form class="edit-subcategory-form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="subcategory_name_{{ $subcategory->id }}" class="form-label">Subcategory
                                    Name</label>
                                <input type="text" class="form-control dlor1" id="subcategory_name{{ $subcategory->id }}"
                                    name="subcategory_name_edit" value="{{ $subcategory->name }}">
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="mb-3">
                                <label for="subcategory_description_{{ $subcategory->id }}" class="form-label">Subcategory
                                    Description</label>
                                <textarea class="form-control dlor1" id="subcategory_description{{ $subcategory->id }}"
