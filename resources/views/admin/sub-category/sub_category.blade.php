                                        ...
                                        <tbody class="ucp-table">
                                            @foreach($subcategories as $subcategory)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <p class="ucp-table">{{ str_pad($subcategory->id, 3, '0', STR_PAD_LEFT) }}
                                                        </p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="ucp-table">{{ $subcategory->category->name }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="ucp-table">{{ $subcategory->name }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <p class="ucp-table">{{ $subcategory->description }}</p>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="toggle-button mt-2 text-center">
                                                            <input type="checkbox" class="toggle-input"
                                                                id="toggle{{$subcategory->id}}" data-user-id="{{$subcategory->id}}"
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <form action="{{ route('sub_category.destroy', $subcategory->id) }}"
                                                            ...
                                                            @csrf
                                                            @method('DELETE')
                                                            <a href="#" title="Delete" class="gray-s delete-btn"
                                                ...
                                                <div class="modal fade" id="editSubcategoryModal{{ $subcategory->id }}"
                                                    tabindex="-1" aria-labelledby="editSubcategoryModalLabel{{ $subcategory->id }}"
                                                    aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form action="{{ route('sub_category.update', $subcategory->id) }}"
                                                                method="POST" enctype="multipart/form-data">
                                                                @csrf
                                                                @method('PUT')
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="editSubcategoryModalLabel{{ $subcategory->id }}">
                                                                        Edit Subcategory
                                                                    </h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    {{-- <div class="mb-3">
                                                                        <label for="category_id_{{ $subcategory->id }}"
                                                                            class="form-label">Category</label>
                                                                        <select class="form-control"
                                                                            id="category_id_{{ $subcategory->id }}"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="subcategory_name_{{ $subcategory->id }}"
                                                                            class="form-label">Subcategory Name</label>
                                                                        <input type="text" class="form-control _dlor1"
                                                                            id="subcategory_name_{{ $subcategory->id }}"
                                                                            name="subcategory_name_edit"
                                                                            value="{{ $subcategory->name }}">
                                                                        <div class="invalid-feedback"></div>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label for="subcategory_description_{{ $subcategory->id }}"
                                                                            class="form-label">Subcategory Description</label>
                                                                        <textarea class="form-control _dlor1"
                                                                            id="subcategory_description_{{ $subcategory->id }}"
                                                                            name="subcategory_description_edit"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="subcategoryForm" action="{{ route('sub_category.store') }}" method="POST"
                        ...
                        @csrf
                        <div class="modal-header">
                            <h5 class="modal-title" id="addSubcategoryModalLabel"><i class="uil uil-plus-circle"></i> Add a
                                New Subcategory</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control _dlor1" id="subcategory_name" name="subcategory_name"
                                    value="{{ old('subcategory_name') }}" placeholder="Enter the subcategory name">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control _dlor1" id="subcategory_description"
                                    name="subcategory_description" rows="4"
                                    placeholder="Enter the subcategory description">{{ old('subcategory_description') }}</textarea>
