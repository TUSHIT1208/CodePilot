                ...
                <div class="col-md-6">
                    <div class="title478">
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed consectetur vel dolor id
                            ...
                            nisl nisi, dapibus eget facilisis sit amet, commodo quis nibh.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="story125">
                        <img src="{{ asset('images/stroy_img.png') }}" alt="">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="title589 text-center">
                        <h2>Meet Our Team</h2>
                        <p>A perfect blend of creativity and technical wizardry. The best people formula for great
                            websites!</p>
                        <img class="line-title" src="{{ asset('images/line.svg') }}" alt="">
                    </div>
                </div>
