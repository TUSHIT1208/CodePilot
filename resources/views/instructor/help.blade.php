                    ...
                    <div class="course_tabs">
                        <nav>
                            <div class="nav nav-tabs help_tabs tab_crse justify-content-center" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-instructor-tab" data-bs-toggle="tab" href="#nav-instructor" role="tab" aria-selected="true">Instructor</a>
                                <a class="nav-item nav-link" id="nav-student-tab" data-bs-toggle="tab" href="#nav-student" role="tab" aria-selected="false">Learner</a>									
                            </div>
                        </nav>						
                    </div>
                </div>
