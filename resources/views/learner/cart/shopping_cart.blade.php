                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a
                                                    href="{{ route('learner.dashboard') }}">Dashboard</a></li>
            ...
            <div class="container">
                @if($cartItems->isEmpty())
                    <div class="no-categories-container text-center fade-in-animation footer">
                        <i class="uil uil-shopping-cart-alt bounce-effect" style="font-size: 50px; color: #d1d1d1;"></i>
                                ...
                                @foreach($cartItems as $cartItem)
                                    <div class="fcrse_1 mt-2">
                                        <a href="{{ route('course.show', $cartItem->course->id) }}" class="hf_img">
                                            <img class="cart_img"
                                                src="{{ asset('courseThumbnail/' . $cartItem->course->thumbnail_url) }}"
