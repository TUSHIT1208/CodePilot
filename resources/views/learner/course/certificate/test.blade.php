                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="certi_form">
                            <div class="all_ques_lest">
                                ...
                                <div class="ques_item">
                                    ...
                                    <div class="ui search focus mt-15">
                                        <div class="ui form swdh30">
                                            <div class="field">
                                                <textarea rows="5" name="answer" id="id_answer"
                                                    placeholder="Pls explain"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="ui form">
                                        <div class="grouped fields">
                                            ...
                                            <div class="field">
                                                <div class="ui radio checkbox">
                                                    <input type="radio" name="example6" tabindex="0" class="hidden">
                                                    <label>Create a sub-folder for PHP files, translations, and
                                                        assets</label>
                                                </div>
                                            </div>
                                            <div class="field fltr-radio">
                                ...
                                <a href="{{route('certificate.index')}}"><button class="test_submit_btn"
                                        type="submit">Submit
                                        Test</button></a>
                            </div>
                        </div>
