                ...
                <div class="col-md-8">
                    <div class="invoice_body">
                        <div class="invoice_date_info">
                            <ul>
                                <li>
                                    <div class="vdt-list"><span>Date :</span>
                                        {{ \Carbon\Carbon::parse($transaction->created_at)->format('d M Y') }}</div>
                                </li>
                                <li>
                                    <div class="vdt-list"><span>Transaction ID :</span> {{ $transaction->transaction_id }}
                                    </div>
                                </li>
                                <li>
                                    <div class="vdt-list"><span>Order ID :</span> {{ $transaction->order->id }}</div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="vhls140">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="vdt-list">{{ auth()->user()->email }}</div>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="vhls140">
                                        ...
                                        <ul>
                                            <li>
                                                <div class="vdt-list">CodePilot LTD</div>
                                            </li>
                                            {{-- <li>
                                                <div class="vdt-list">Ludhiana, Punjab, India</div>
                                            </li> --}}
                                        </ul>
                                    </div>
                                </div>
