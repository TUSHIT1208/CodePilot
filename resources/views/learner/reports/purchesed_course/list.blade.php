                ...
                <div class="col-md-12">
                    <div class="card_dash1">
                        ...
                        @else
                            <div class="row">
                                <div class="col-md-3">
                                    <label for="enrollDateRange" class="font-weight-bold">Filter by Purchased Course
                                        date:</label>
                            ...
                            <table id="purchasedCoursesTable" class="ucp-table">
                                <thead>
                                    <tr>
                                        <th>Course Title</th>
                                        <th>Amount Paid</th>
        ...
        $(document).ready(function() {
            ...
            let table = $('#purchasedCoursesTable').DataTable({
                ...
                ajax: {
                    ...
                    type: "GET",
                    data: function(d) {
                        d.date_range = $('#enrollDateRange')
                    .val(); // Pass the selected date range to the server
